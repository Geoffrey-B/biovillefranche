...
//Paramètres
$params = array(':idCategorie' => $_GET['id']);

//Exécution
if($stmtSupp->execute($params)) {
    header('location:admin.php');
} 
} else echo '<div class="alert alert-danger">Certains produits sont classés dans cette catégorie. Vous ne pouvez pas la supprimer.<br><a href="#" onclick="window.history.go(-1); return false;">Retour</a></div>';
